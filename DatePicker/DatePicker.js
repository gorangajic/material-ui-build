...
var DatePicker = function (_Component) {
  ...
  function DatePicker() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DatePicker.__proto__ || (0, _getPrototypeOf2.default)(DatePicker)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      date: undefined,
      isFocused: false
    }, _this.element = null, _this.handleAccept = function (date) {
    ...
    }, _this.handleBlur = function (event, shouldSetFocus) {
      if (shouldSetFocus) {
        _this.refs.input.focus();
      }
      ...
      if (!_this.props.disabled && !_this.state.isFocused) {
        _this.setState({
          isFocused: true
        }, _this.openDialog);
      }
      ...
      if (!_this.refs.dialogWindow.state.open) {
        return;
      }

      switch ((0, _keycode2.default)(event)) {
        case 'tab':
          _this.handleBlur(event, !_this.element.contains(event.target));
          break;
      }
  ...
  (0, _createClass3.default)(DatePicker, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          other = (0, _objectWithoutProperties3.default)(_props, ['DateTimeFormat', 'autoOk', 'cancelLabel', 'className', 'container', 'defaultDate', 'dialogContainerStyle', 'disableYearSelection', 'firstDayOfWeek', 'formatDate', 'locale', 'maxDate', 'minDate', 'mode', 'okLabel', 'onFocus', 'onShow', 'onTouchTap', 'shouldDisableDate', 'style', 'textFieldStyle']);
